...
[![Kotlin](https://img.shields.io/badge/kotlin-1.5.0%20RC-blue.svg?logo=kotlin)](http://kotlinlang.org)
...
plugins {
    ...
    id("com.github.turansky.kfc.webpack") version "3.10.0"
}
...
plugins {
    kotlin("js") version "1.5.0-RC"
    id("com.github.turansky.kfc.library") version "3.10.0"
}
```
